        ...
        <div ref={pinnedRef} className="h-dvh w-full overflow-hidden relative bg-canvas">
          ...
          <div className="layer absolute inset-0 flex items-center justify-center opacity-0 will-change-transform z-20">
            <div className="layer-inner will-change-transform max-w-4xl px-6 text-center relative">
              <span className="absolute -top-6 -left-2 sm:-left-6 font-display text-[14rem] sm:text-[20rem] leading-[0.5] text-amber/[0.07] select-none pointer-events-none">&ldquo;</span>
              <span className="absolute -bottom-2 right-0 sm:-right-6 font-display text-[14rem] sm:text-[20rem] leading-[0.5] text-amber/[0.07] select-none pointer-events-none">&rdquo;</span>
