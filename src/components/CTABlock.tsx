  ...
  return (
    <section className="py-32 px-6 sm:px-14 flex items-center justify-center text-center" style={{ borderTop: "1px solid rgba(240,235,227,0.08)" }}>
      <ScrollReveal stagger>
        <h2 className="reveal font-[var(--font-display)] font-700 text-[clamp(2rem,4vw,3rem)] tracking-[-0.02em] mb-4" style={{ color: "#f0ebe3" }}>
          Ready to talk?
        </h2>
        <p className="reveal font-[var(--font-body)] text-sm mb-12 max-w-md mx-auto" style={{ color: "#6b6560" }}>
        ...
        <div className="reveal flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          ...
          <a
            href="/contact"
            className="inline-flex items-center gap-2 font-[var(--font-body)] text-sm transition-colors duration-300"
            style={{ color: "#c4835a" }}
          >
            Request Information
        ...
        <p className="reveal font-[var(--font-body)] italic text-sm max-w-md mx-auto leading-relaxed" style={{ color: "#6b6560" }}>
