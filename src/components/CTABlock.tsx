...
export default function CTABlock() {
  return (
    <section
      className="py-32 px-6 sm:px-14 flex items-center justify-center text-center"
      style={{ borderTop: "1px solid rgba(240,235,227,0.08)" }}
    >
      <div>
        <h2
          className="font-[var(--font-display)] font-700 text-[clamp(2rem,4vw,3rem)] tracking-[-0.02em] mb-4"
          style={{ color: "#f0ebe3" }}
        >
          Ready to start?
        </h2>
        <p
          className="font-[var(--font-body)] text-sm mb-12 max-w-md mx-auto"
          style={{ color: "#6b6560" }}
        >
          Tell us about your project. We&rsquo;ll get back within one business day.
        </p>
        ...
        >
          Not ready yet? See how we work first
        ...
        <p
          className="font-[var(--font-body)] italic text-sm max-w-md mx-auto leading-relaxed"
          style={{ color: "#6b6560" }}
        >
